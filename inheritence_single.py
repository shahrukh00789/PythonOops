...
class Programmer(Employee):
    ...
    def __init__(self,aname,asalary,arole,askill):
        self.name = aname
        self.salary = asalary
        self.role = arole
        self.skill = askill
    ...
    def printprogram(self):
        print(f"Programmer name is {self.name} .and salary is {self.salary} and role is {self.role} and skills were {self.skill} ")

Aziz = Programmer("Subham",5555,"Programmer",["Python"])
# Srk = Programmer("Srk",6666,"Programmer")
